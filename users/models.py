...
class MyUserManager(BaseUserManager):
    ...
    def _create_user(self, phone, password, **extra_fields):         # username optional thakbe.. email and password diye e kaj hobe.
        """ Creates and saves a user with email and password """

        if not phone:
            raise ValueError("The Email must be Required!!!")

        phone = self.normalize_phone(phone)   # exactly jemon ase temon likte hobe
